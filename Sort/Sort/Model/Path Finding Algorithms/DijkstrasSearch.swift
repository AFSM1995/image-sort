...
//                            fronterPriorityQueueClass.add(square: prospectSquare, cost: prospectPathCost)
                            ...
                            let costInQueue = fronterPriorityQueueClass.heap[prospectSquare]
                            if costInQueue! > prospectPathCost {
                                fronterPriorityQueueClass.heap[prospectSquare] = prospectPathCost
                            }
...
//                            print("stored:", visitedSquaresAndCost[tempIndex!])
//                            print("prospect:", prospectSquare, prospectPathCost)
//                            print("square and parent", prospectSquare, currentSquare)
//                            print(" ")
